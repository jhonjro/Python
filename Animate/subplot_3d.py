...
# import numpy as np
# import mathplotlib
from numpy import sin, cos, exp, zeros, pi
from matplotlib.pylab import subplot2grid, figure, show, append
...
f0 = figure(num = 0, figsize = (12, 8))#, dpi = 1000.suptitle("Oscillation decay", fontsize=12)
...
simulation = animation.FuncAnimation(f0, updateData, blit=True, frames=200, interval=200, repeat=True)

# Uncomment the next line if you want to save the animation
# simulation.save(filename='sim.mp4')
#fps=30,dpi=300
show()
